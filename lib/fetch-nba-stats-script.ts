/**
 * The Python script that fetches NBA stats, embedded as a string.
 *
 * We embed this rather than reading from disk because the Fresh build
 * process doesn't include .py files in the output bundle. By storing
 * it as a TypeScript string, it gets bundled with the server code and
 * is available on Deno Deploy.
 *
 * The source of truth is scripts/fetch_nba_stats.py — if you update
 * that file, re-copy the content here.
 */

export const FETCH_NBA_STATS_PY = `"""
